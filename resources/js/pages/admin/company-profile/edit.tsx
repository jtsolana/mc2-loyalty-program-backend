...
import { Building2, CheckCircle, FileText, Mail, MapPin, Phone, Upload } from 'lucide-react';
  ...
  return (
      <AppLayout breadcrumbs={breadcrumbs}>
          ...
          <div className="flex flex-col gap-6 p-4 md:p-6">
              ...
              {flash.success && (
                  <Alert className="max-w-6/12 border-green-200 bg-green-50 text-green-800 dark:border-green-800 dark:bg-green-950 dark:text-green-300">
                      <CheckCircle className="size-4 text-green-600 dark:text-green-400" />
                      <AlertDescription>{flash.success}</AlertDescription>
                  </Alert>
              )}

              <form onSubmit={handleSubmit} className="max-w-6/12">
                  <div className="rounded-2xl border border-border bg-card shadow-xs">
                      ...
                      <div className="flex flex-col gap-5 px-6 py-5">
                          ...
                          <div className="grid grid-cols-2 gap-4">
                              ...
                              <div className="grid col-span-2 gap-1.5">
                                  ...
                                  <RichTextEditor
                                      ...
                                      placeholder="Enter company terms and conditions"
                                  />
